...
{
    /// <summary>
    ///     Добавить JSON файл в конфигурацию с наименьшим приоритетом (любой другой конфиг, добавленный ранее, будет иметь
    ///     приоритет над ним)
    /// </summary>
    ...
    /// <remarks>
    ///     Метод устанавливает файлу минимальный приоритет из имеющихся. Если вызвать этот метод на два разных файла,
    ///     высший приоритет будет иметь тот, который был добавлен ранее
    /// </remarks>
    /// <returns></returns>
